...
blastn -db /scratch365/ssmall2/blast_db/db/anopheles/anopheles.fsa -num_threads 20 -outfmt '6 qseqid sseqid evalue bitscore qlen length pident mismatch qcovs qcovus qstart qend sstart send' -max_target_seqs 1 -max_hsps 50 -query ${1}.notmapping2.fasta > ${1}.discovar.blastn.out
